...
namespace Alg_tetelek
{
    class MainClass
    {
        ...
        static void tetel_21()
        {

        }

        static void tetel_22()
        {
            int[] tömb = random_tomb(50, 1000);
            Console.WriteLine("Az aktuális tömb elemei: " + string.Join(",", tömb) + "\n");
            int db = 0;
            for (int i = 0; i < tömb.Length; i++)
            {
                if(tömb[i] % 5 == 0) {
                    ++db;
                    Console.WriteLine("Ezeken az indexeken vannak: " + i + " érték: " + tömb[i]);
                }
            }
            Console.WriteLine("\nEnnyi 5-tel osztható elem van a tömbben: " + db);
        }

        static void tetel_23()
        {
            int[] tömb = random_tomb(15, 1000);
            Console.WriteLine("Az aktuális tömb elemei: " + string.Join(",", tömb) + "\n");
            int max = 0;
            ...
            Console.WriteLine("A legnagyobb elem értéke a tömbben: " + tömb[max]);
        }

        static void tetel_24()
        {
            int[] tömb = random_tomb(15, 1000);
            Console.WriteLine("Az aktuális tömb elemei: " + string.Join(",", tömb) + "\n");
            int max = 0;
            ...
            Console.WriteLine("A legnagyobb elem pozíciója a tömbben: " + max);

        }


        static void tetel_25()
        {
            int[] tömb = random_tomb(30, 1000);
            Console.WriteLine("Az aktuális tömb elemei: " + string.Join(",", tömb));
            int min = 0;
            ...
            Console.WriteLine("A legkissebb elem értéke a tömbben: " + tömb[min]);

        }

        static void tetel_26()
        {
            int[] tömb = random_tomb(15, 1000);
            Console.WriteLine("Az aktuális tömb elemei: " + string.Join(",", tömb));
            int min = 0;
            ...
            Console.WriteLine("A legkissebb elem pozíciója a tömbben: " + min);
        }
